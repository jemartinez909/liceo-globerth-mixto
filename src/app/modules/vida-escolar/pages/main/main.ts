  ...
  eventos: Evento[] = [
    {
      ...
      imagen: 'https://liceogloberth.edu.co/images/proyectos/humanidades/L1.jpg',
      icono: `
      <svg viewBox="0 0 24 24">
          <path fill="currentColor"
            d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20v2H6.5
            a.5.5 0 0 0 0 1H21v2H6.5A2.5 2.5 0 0 1
            4 19.5ZM20 2H8a2 2 0 0 0-2 2v11.5
            A3.5 3.5 0 0 1 6.5 15H20Z"/>
        </svg>
      ` 
    },
    {
      ...
      imagen: 'https://liceogloberth.edu.co/images/proyectos/democracia/l2.jpg',
      icono: `
      <svg viewBox="0 0 24 24">
          <path fill="currentColor"
            d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20v2H6.5
    ...
    },
    {
      ...
      imagen: 'https://liceogloberth.edu.co/images/proyectos/tiempolibre/L1.jpg',
      icono: `
      <svg viewBox="0 0 24 24">
          <path fill="currentColor"
            d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20v2H6.5
    ...
    },
    {
      ...
      imagen: 'https://liceogloberth.edu.co/images/proyectos/prevencion/l2.jpg',
      icono: `
      <svg viewBox="0 0 24 24">
          <path fill="currentColor"
            d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20v2H6.5
    ...
    },
    {
      ...
      imagen: 'https://liceogloberth.edu.co/images/proyectos/ambiental/l1.jpg',
      icono: `
      <svg viewBox="0 0 24 24">
          <path fill="currentColor"
            d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20v2H6.5
